    ...
    <div id="main-app" className="flex h-screen w-screen overflow-hidden">
      ...
      <main className="dashboard-main-modern flex-1 flex flex-col h-screen overflow-hidden relative bg-bgDashboard">
        ...
        <header className="dashboard-header-modern pt-6 pb-4 px-8 shrink-0">
          ...
          <div className="flex justify-between items-end mt-4 gap-3 flex-wrap">
            <div>
              <h2 className="text-3xl font-black text-cetecBlue tracking-tight">Visão Geral Estratégica</h2>
            ...
            <div className="flex items-center gap-2">
              <button type="button" onClick={handleExportExcel} className="bg-white text-cetecBlue font-black py-2.5 px-4 rounded-xl border border-blue-100 hover:bg-blue-50 text-xs shadow-sm transition inline-flex items-center gap-1.5">
                <span className="material-symbols-rounded text-[16px]">table_view</span>
                Excel
              </button>
              <button type="button" onClick={handleExportPdf} className="bg-white text-cetecBlue font-black py-2.5 px-4 rounded-xl border border-blue-100 hover:bg-blue-50 text-xs shadow-sm transition inline-flex items-center gap-1.5">
